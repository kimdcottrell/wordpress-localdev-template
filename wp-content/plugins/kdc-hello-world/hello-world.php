...
add_action(
	...
	function () {
		add_menu_page(
			...
			KDC_HW__PLUGIN_DIR . 'includes/index.php' // The 'slug' - file to display when clicking the link.
		);
	}
);
	...
	function () {
		register_post_type(
			...
			array(
				...
				'taxonomies'    => array( 'landing_page_audience' ), // declare the relationship part 1/3.
				'labels'        => array(
		...
		register_taxonomy(
			...
			array( 'landing_page' ),
			array( // declare the relationship part 2/3.
				'label'             => __( 'Audiences', 'txtdomain' ),
				'hierarchical'      => true,
				'rewrite'           => array( 'slug' => 'landing-page-audience' ),
